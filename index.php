    ...
    <body>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input  id="usname" runat="server" type="text" value="test" class="form-control" name="user" autofocus="autofocus" placeholder="User Name" required="" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input id="password" runat="server" type="password" value="123" class="form-control" name="password" placeholder="Password" required="" />
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#log').click(function () {
                ...
                $.post('EmpReg.php', {logsystem: 'loging', usname: usname, password: password},
                function (loging) {
